...
to init
  ...
  let img  bitmap:import "D:\\Program Files (x86)\\NetLogo 5.2.1\\patch.png"
  bitmap:copy-to-pcolors img true
  ...
  ask patches [
    ...
    if (pcolor >= 50 and pcolor <= 79) [
      set pcolor 65;green, stands for pile of food 1
      set food 1
    ]
    if (pcolor >= 80 and pcolor <= 109) [
...
to-report nest-scent-at-angle [angle]
  ...
  if [wall?] of p [ report 0 ]
  report 200 - sqrt (([pxcor] of p)*([pxcor] of p) + ([pycor] of p)*([pycor] of p))
end

to hill-climbing-nest
